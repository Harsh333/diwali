            ...
            <td>
                ...
                <div style="position: relative; text-align: center; display: none;" id="div2">
                    <form method="get" action="">
                        ...
                        <button onclick="makeShort('http://diwaligreetings.tk/?n=<?php echo $_GET['n']?>')" type="submit" id="button1" style="height: 70px; background-color: #4CAF50; color: white; border-style: solid; border-width: 5px; border-radius: 10px; border-color: #2D6525; font-size:25px; font-weight:bold;">Create</button>
                    </form>
                </div>
